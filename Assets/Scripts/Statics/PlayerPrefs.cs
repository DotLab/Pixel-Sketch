...
namespace PreviewLabs {
	public static class PlayerPrefs {
		const string PARAMETERS_SEPERATOR = ";";
		const string KEY_VALUE_SEPERATOR = ":";

		static readonly string[] seperators = { PARAMETERS_SEPERATOR, KEY_VALUE_SEPERATOR };
		static readonly string fileName = Application.persistentDataPath + "/PlayerPrefs.txt";
		static readonly string secureFileName = Application.persistentDataPath + "/AdvancedPlayerPrefs.txt";

		static readonly Hashtable playerPrefsHashtable = new Hashtable();
		static bool hashTableChanged = false;
		static string serializedOutput = "";
		static string serializedInput = "";

		static bool wasEncrypted = false;
		static bool securityModeEnabled = false;
		//NOTE modify the iw3q part to an arbitrary string of length 4 for your project, as this is the encryption key
		static byte[] bytes = Encoding.ASCII.GetBytes("dfjr" + SystemInfo.deviceUniqueIdentifier.Substring(0, 4));
		...
		static object GetTypeValue (string typeName, string value) {
