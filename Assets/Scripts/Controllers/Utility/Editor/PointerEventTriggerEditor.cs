	...
	public class PointerEventTriggerEditor : Editor {
		...
		public override void OnInspectorGUI () {
			...
			for (int i = 0; i < m_DelegatesProperty.arraySize; ++i) {
				...
				SerializedProperty eventProperty = delegateProperty.FindPropertyRelative("eventType");
		...
		void ShowAddTriggermenu () {
			...
			for (int i = 0; i < m_EventTypes.Length; ++i) {
				...
				for (int p = 0; p < m_DelegatesProperty.arraySize; ++p) {
					...
					SerializedProperty eventProperty = delegateEntry.FindPropertyRelative("eventType");
